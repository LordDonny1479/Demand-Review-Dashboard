...
function buildDemandReview(rows, baseYear = 2025, comparisonYear = 2026) {
...
function pivotByRetailerAndMpg(rows) {
  const pivot = new Map();
  rows.forEach((row) => {
...
if (typeof module !== 'undefined') {
  module.exports = { MONTHS, parseCsv, toCases, buildDemandReview, pivotByRetailerAndMpg };
}
